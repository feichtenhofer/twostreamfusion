function [ fn ] = getBatchWrapper_ucf101_flow(opts, numThreads, trainopts)

fn = @(imdb,batch,valopts,frameList) getBatch(imdb,batch,opts,numThreads, trainopts, valopts) ;
end
...
im = cnn_ucf101_get_flow_batch(images, opts, ...
                            'numThreads', numThreads, ...
                            'augmentation', opts.augmentation , ...
                          'imageDir', imdb.flowDir) ;
